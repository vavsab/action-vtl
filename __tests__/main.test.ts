...
test('compareSemvers with pre-release and metadata', async () => {
  ...
  expect(compareSemvers("1.0.0-alpha.1+some-meta-data", "1.0.0-alpha.beta+some-other-data")).toEqual(-1);
  expect(compareSemvers("1.0.0-alpha.1.2+some-meta-data", "1.0.0-alpha.1+some-other-data")).toEqual(1);
});
